...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        **ignore_kwargs,
        ...
        #print(f"vision_projection_type: {self.vision_projection_type}",self.vision_projection_type)#custom
        ...
        if self.vision_projection_type != "none":
            ...
            print("init encoder_hidden_states_vision_projection")
    ...
    def forward(
        ...
        #print("vision_input_dict", vision_input_dict,self.vision_projection_type)
